...
function createAd() {
    ...
    adDiv.className = 'ad-banner ad-inline';
    adDiv.textContent = 'Inline Advertisement - Support Us!';
    return adDiv;
}
...
function renderSinglePost() {
    ...
    if (post) {
        ...
        singlePostContainer.innerHTML = `
            ...
            <!-- Bottom Ad -->
            <div class="ad-banner ad-inline" style="margin-top: 4rem;">
                Thanks for reading! (Ad Space)
            </div>
        `;
    } else {
        singlePostContainer.innerHTML = `
